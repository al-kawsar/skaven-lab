        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                @if (auth()->user()->isAdmin())
                    ...
                    <li class="submenu {{ request()->routeIs('labs.*') ? 'active' : '' }}">
                        <a href="#"><i class="fa fa-building"></i> <span>Laboratorium</span> <span
                                class="menu-arrow"></span></a>
                        <ul>
                            <li>
                                <a href="{{ route('labs.index') }}"
                                    class="{{ request()->routeIs('labs.index') ? 'active' : '' }}">Data
                                    Lab</a>
                            </li>
                            @if (auth()->user()->hasRole('superadmin'))
                                <li></li>
                                <a href="{{ route('labs.create') }}"
                                    class="{{ request()->routeIs('labs.create') ? 'active' : '' }}">Tambah
                                    Lab</a>
                    </li>
                @endif
            </ul>
            ...
            <li
                class="submenu {{ request()->routeIs('borrowing.lab.admin.*') || request()->routeIs('borrowing.labs.*') ? 'active' : '' }}">
            ...
            <li
                ...
                <a href="#"><i class="fa fa-users"></i> <span>Pengguna</span> <span class="menu-arrow"></span></a>
                <ul>
                    <li>
            ...
            <li class="{{ request()->routeIs(patterns: 'borrowing.lab.list') ? 'active fw-semibold' : 'fw-medium' }}">
                <a href="{{ route('borrowing.lab.list') }}"><i class="fa fa-microscope"></i><span>Pinjam Lab</span></a>
            </li>
            <li class="{{ request()->routeIs('item.index') ? 'active' : '' }}">
                <a href="{{ route('item.index') }}"><i class="fa fa-dolly"></i><span>Pinjam Barang</span></a>
            </li>
            <li class="{{ request()->routeIs('borrowing.lab.index') ? 'active' : '' }}">
            ...
            <li class="submenu {{ request()->routeIs('settings.*') ? 'active' : '' }}">
                <a href="#"><i class="fa fa-cog"></i> <span>Pengaturan</span> <span class="menu-arrow"></span></a>
                <ul>
                    <li>
