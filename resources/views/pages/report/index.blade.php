...
@section('content')
    <!--
            <div class="student-group-form">
                <form class="row" method="GET" action="{{ route('labs.index') }}">
                    <div class="col">
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        var editUrl = '{{ route('labs.edit', ':id') }}'.replace(':id', full.id);
                        var deleteUrl = '{{ route('labs.destroy', ':id') }}'.replace(':id', full.id);
