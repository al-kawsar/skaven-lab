                    ...
                    <div class="page-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto text-end float-end ms-auto download-grp">
                                <a href="{{ route('student.statistics.view') }}" class="btn btn-info text-white me-2">
                                ...
                                <div class="btn-group me-2">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="importDropdown">
                                        ...
                                        <li><a class="dropdown-item" href="{{ route('student.import.template') }}">Download
                                                Template</a>
                                        </li>
                                    </ul>
                                </div>
                ...
                <form action="{{ route('student.import') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="alert alert-info">
                            ...
                            <a href="{{ route('student.import.template') }}" class="alert-link">Download
                                Template</a>
                        </div>
                    </div>
                    <div class="modal-footer">
...
@push('script')
    <script>
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        var editUrl = '{{ route('student.edit', ':id') }}'.replace(':id', full.id);
                        var showUrl = '{{ route('student.show', ':id') }}'.replace(':id', full.id);
        ...
        $('#export-excel').click(function(e) {
            ...
            var url = "{{ route('student.export.excel') }}?" + $.param(params);
        ...
        $('#siswaTable').on('click', '.btn-delete', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: `{{ route('student.destroy', ':id') }}`.replace(':id', siswaId),
                        type: 'DELETE',
