                ...
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        ...
                        <div class="d-flex p-0 m-0 align-items-center justify-content-center">
                                ...
                                <button class="btn btn-sm btn-delete" data-siswa="${full.id}"><i class="feather-trash"></i></button>
                            <div class="dropdown dropdown-action p-0 m-0">
                                <a href="javascript:;" class="btn btn-sm" data-bs-toggle="dropdown" aria-expanded="false"><i class="fas fa-ellipsis-v"></i></a>
                                <div class="dropdown-menu dropdown-menu-end">
                                    <a class="dropdown-item" href="${showUrl}"><i class="far fa-eye me-2"></i>Detail</a>
                                    <a class="dropdown-item" href="javascript:;"><i class="far fa-trash-alt me-2"></i>Tambah Foto Slider</a>
                                </div>
                            </div>
                        </div>
                    `;
