            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        ...
                        return `
                        <div class="actions">
                            <a target="_blank" href="${showUrl}" class="btn btn-sm bg-success-light" title="Lihat Detail">
                                <i class="feather-eye"></i>
                            </a>
                            <a href="${editUrl}" class="btn btn-sm bg-warning-light mx-1" title="Edit">
                                <i class="feather-edit"></i>
                            </a>
                            <button class="btn btn-sm bg-danger-light btn-delete" data-siswa="${full.id}" title="Hapus">
