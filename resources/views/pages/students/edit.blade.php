    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card comman-shadow">
                <div class="card-body">
                    <form action="{{ route('admin.student.update', $siswa->id) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                <div class="form-group local-forms">
                                    ...
                                    <input required class="form-control" name="name" type="text"
                                        value="{{ old('name', $siswa->name) }}" placeholder="Enter First Name">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group local-forms">
                            ...
                            <div class="col-12">
                                <div class="form-group local-forms">
                                    ...
                                    <input required class="form-control" name="alamat" type="text"
                                        value="{{ old('alamat', $siswa->alamat) }}" placeholder="Enter Address">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group local-forms">
                                    ...
                                    <select class="form-control select" name="jenis_kelamin" required>
                                        <option value="1" @selected($siswa->jenis_kelamin == 'l')>Laki Laki</option>
                                        <option value="2" @selected($siswa->jenis_kelamin == 'p')>Perempuan</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group local-forms">
                                    ...
                                    <input required class="form-control" name="agama" type="text"
                                        value="{{ old('agama', $siswa->agama) }}" placeholder="Enter Religion">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group local-forms calendar-icon">
                                    ...
                                    <input class="form-control datetimepicker" required name="tgl_lahir" type="text"
                                        value="{{ old('tgl_lahir', $siswa->tgl_lahir) }}" placeholder="DD-MM-YYYY">
                                </div>
                            </div>
                            <div class="col-12">
